...
define('SITE_ROOT',DOC_ROOT.'/github/Library/trunk/libr/');
define('SITE_PATH','http://'.$_SERVER['HTTP_HOST'].'/github/Library/trunk/libr/');
...
define('DATABASE_PATH',SITE_ROOT.'library/');
