...
class DBConnection {
    ...
    public static function Connect() {
        if (is_null(DBConnection::$instance)) {
            ...
            $db = mysql_connect(self::$_host, self::$_user, self::$_password) or die("database error");
            if ($db) {
                mysql_select_db(self::$_database, $db) or die("database error");
...
// if(empty($this->_transaction))//ani
// {            
                echo $this->_query; echo(" insert query <br/>" );
