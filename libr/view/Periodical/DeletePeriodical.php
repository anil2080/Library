<html>
<head>
<title> DELETE PERIODICAL DETAILS</title>
...
<div id="frmDiv">
<form action="<?php echo SITE_PATH?>index.php?controller=admin&function=DELETEPeriodical_Click" method="post" id="AddMember">
