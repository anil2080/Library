...
<body>
	<div id="outerDiv">
		<div id="headerDiv">
			...
			<div id="frmDiv">
				<form
					action="<?php echo SITE_PATH?>index.php?controller=admin&function=AddMember_Click"
					...
					<table id="frmTable">
						...
						<tr>
							...
							<td><input type="text" name="department" pattern="[a-zA-Z ]{0,}" /></td>
							<td><p>year Of Joining*</p></td>
						...
						<tr>
							...
							<td><p>Street Id*</p></td>
							<td><input type="text" name="street_id" /></td>
						</tr>
						<tr>
							<td><p>State Id*</p></td>
							<td><input type="text" name="state_id" /></td>
						...
						<tr>
							...
							<td><p>Remarks</p></td>
							<td colspan="3"><textarea name="remark" cols="50" rows="4"></textarea></td>
						</tr>
						<tr>
							<td><p>Contact Number*</p></td>
							<td><input type="text" name="contact_number" /></td>
							<td><p>Max Copy*</p></td>
							<td><input type="text" name="max_copy" /></td>
						</tr>
						<tr>
							<td><p>Copy Alloted</p></td>
							<td><input type="text" name="copy_alloted" /></td>
							<td><p>Visible</p></td>
							<td><input type="text" name="visible" /></td>
						</tr>
						<tr>
							<td><p>Fine Till Yet</p></td>
							<td><input type="text" name="fine_till_yet" /></td>
							<td><p>Fine Paid</p></td>
							<td><input type="text" name="fine_paid" /></td>
						</tr>
						<tr>
							<td><p>Image Extension</p></td>
							<td><input type="text" name="image_extension" /></td>
							<td><p>Reserve Void Date</p></td>
							<td><input type="text" name="reserve_void_date" /></td>
						</tr>
						<tr>
							<td><p>Reserve Id</p></td>
							<td><input type="text" name="reserve_id" /></td>
							<td><p>Reserve Void Date</p></td>
							<td><input type="text" name="reserve_void_date" /></td>
						</tr>
