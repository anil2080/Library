...
<!--             </ul>     -->
            ...
            <div id="frmDiv">
                <form action="<?php echo SITE_PATH?>index.php?controller=admin&function=DeleteBook_Click" method="post" id="AddBook">
                 <input type="hidden" name="book_id" value="" />
                 <input type="hidden" name="id_for_copies" value="" />
                    <table id="frmTable">                     
                        <tr>
                            <td>existing book id<input type="text" name="existing_book_id" value="" /></td>
                            <!-- <td><p>Accession number*</p></td><td><input type="text" name="existing_book_id"  /></td> -->
                            <td><p>Book Title*</p></td><td><input type="text" name="book_title" /></td>
                        </tr>
                        <tr>
                            <td><p>Author Name*</p></td><td><input type="text" name="author_name" pattern="[a-zA-Z ]{0,}"  /></td>
                            <td><p>Publisher Name*</p></td><td><input type="text" name="publisher_name"  /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><p>Main Subject*</p></td><td><input type="text" name="main_subject_id"  /></td>
                             <td><p>Addition*</p></td><td><input type="text" name="addition"  /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><p>Bill Number*</p></td><td><input type="text" name="bill_detail_id"  /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><p>Isbn Number*</p></td><td><input type="text" name="isbn_number"  /></td>
                        </tr>
                        <tr>
                             <td><p>Issued TO</p></td><td><input type="text" name="issued_to"  /></td>
                             <td><p>Reserve For</p></td><td><input type="text" name="reserve_for"  /></td>
                        </tr>
                        <tr>
